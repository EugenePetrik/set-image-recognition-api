...
output "deployment_info" {
  ...
  value = {
    environment           = var.environment
    application_url       = var.certificate_arn != "" ? "https://${var.domain_name != "" ? var.domain_name : module.application.alb_dns_name}" : "http://${module.application.alb_dns_name}"
    health_check_url      = var.certificate_arn != "" ? "https://${var.domain_name != "" ? var.domain_name : module.application.alb_dns_name}/api/v1/health" : "http://${module.application.alb_dns_name}/api/v1/health"
    api_docs_url         = var.certificate_arn != "" ? "https://${var.domain_name != "" ? var.domain_name : module.application.alb_dns_name}/api/docs" : "http://${module.application.alb_dns_name}/api/docs"
  }
}
